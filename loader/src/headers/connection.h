...
//int connection_consume_psoutput(struct connection *conn); // 1
//int connection_consume_mounts(struct connection *conn); // 2
//int connection_consume_written_dirs(struct connection *conn); // 3
